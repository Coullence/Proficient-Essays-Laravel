                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @if(config('usersmanagement.enableSearchUsers'))
                            @include('partials.Admin.search-rejectedOrders-form')
                        @endif
                            ...
                            <table class="table table-striped table-sm data-table">
                                ...
                                <thead class="thead">
                                    <tr>
                                        ...
                                        <th class="hidden-xs">{!! trans('Client') !!}</th>
                                ...
                                <tbody id="users_table">
                                    @foreach($orders as $order)
                                        <tr>
                                           ...
                                           <td class="hidden-xs">{{$order->due}}</td> <td class="hidden-xs"><a href="mailto:{{ $order->email }}" title="email {{ $order->email }}">{{ $order->email }}</a></td>
                                           <td class="hidden-xs" > <span class="badge badge-danger">{{$order->status}}</span></td>
...
@section('footer_scripts')
    ...
    @endif
      @if(config('usersmanagement.enableSearchUsers'))
        @include('scripts.Admin.search-RejectedOrders')
    @endif
@endsection
