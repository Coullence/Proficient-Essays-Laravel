            ...
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    ...
                    <div class="card-body">
                       <!--  url('/reply/'.$order->id) 
 -->
                        {!! Form::open(array('url' => 'reply/'.$order->id, 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation', 'files'=>true)) !!}

                            {!! csrf_field() !!}

                                      <!--Clients Name-->
                      <input type="hidden" id="OUID" name="OUID" value="{{$order->OUID}}">
                            <!--User Email-->
