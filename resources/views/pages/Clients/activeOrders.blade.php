                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @if(config('usersmanagement.enableSearchUsers'))
                            @include('partials.search-activeOrder-form')
                        @endif
                                    ...
                                    @foreach($orders as $order)
                                        <tr>
                                           ...
                                           <td class="hidden-xs" > <span class="badge badge-primary">{{$order->status}}</span></td>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-success btn-block" href="{{ URL::to('active_orders/' . $order->id) }}" data-toggle="tooltip" title="Show">
                                                    {!! trans('usersmanagement.buttons.show') !!}
                                                </a>
                                            </td>
                                            <td>
                                                <a class="btn btn-sm btn-info btn-block" href="{{ URL::to('active_orders/' . $order->id . '/edit') }}" data-toggle="tooltip" title="edit">
                                                    {!! trans('usersmanagement.buttons.edit') !!}
                                                </a>
                                            </td>
                                             <td>
                                                {!! Form::open(array('url' => 'active_orders/' . $order->id, 'class' => '', 'data-toggle' => 'tooltip', 'title' => 'Delete')) !!}
...
@section('footer_scripts')
    ...
    @endif
    @if(config('usersmanagement.enableSearchUsers'))
        @include('scripts.Clients.search-ActiveOrders')
    @endif
@endsection 
