<script>
    $(function() {
        ...
        var searchform = $('#search_inProgressOrders');
        ...
        searchform.submit(function(e) {
            ...
            $.ajax({
                type:'POST',
                url: "{{ route('search_inProgressOrders') }}",
                ...
                success: function (result) {
                    ...
                    if (jsonData.length != 0) {
                        $.each(jsonData, function(index, val) {
                            ...
                            let editCellHtml = '<a class="btn btn-sm btn-info btn-block" href="active_orders/' + val.id + '/edit" data-toggle="tooltip" title="{{ trans("usersmanagement.tooltips.edit") }}">{!! trans("usersmanagement.buttons.edit") !!}</a>';
