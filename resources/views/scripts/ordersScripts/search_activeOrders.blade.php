<script>
    $(function() {
        ...
        searchform.submit(function(e) {
            ...
            $.ajax({
                type:'POST',
                url: "{{ route('search-users') }}",//define the route
                    ...
                    if (jsonData.length != 0) {
                        $.each(jsonData, function(index, val) {
                            ...
                            resultsContainer.append('<tr>' +
                                '<td>' + val.category + '</td>' +
                                '<td class="hidden-xs">' + val.topic + '</td>' +
                                '<td class="hidden-xs">' + val.pages + '</td>' +
                                '<td class="hidden-xs">' + val.format + '</td>' +
                                '<td class="hidden-xs">' + val.duration + '</td>' +
