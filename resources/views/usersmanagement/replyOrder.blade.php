        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="pull-right">
                                ...
                                <a href="{{ url('/users/' . $order->id) }}" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="left" title="{{ trans('usersmanagement.tooltips.back-users') }}">
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => ['users.replyOrder', $order->id], 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
