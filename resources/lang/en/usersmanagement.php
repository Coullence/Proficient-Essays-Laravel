...
return [
    ...
    'users-table' => [
        'caption'   => '{1} :orderscount orders total|[2,*] :orderscount total Orders',
        'id'        => 'ID',
        'name'      => 'Username',
        'fname'     => 'First Name',
        'lname'     => 'Last Name',
    ...
    'buttons' => [
        ...
        'delete-user'   => '<i class="fa fa-trash-o fa-fw" aria-hidden="true"></i>  <span class="hidden-xs">Delete</span><span class="hidden-xs"> Order</span>',
        'edit-user'     => '<i class="fa fa-pencil fa-fw" aria-hidden="true"></i> <span class="hidden-xs">Edit</span><span class="hidden-xs"> Order</span>',
        'replyOrder'     => '<i class="fa fa-reply fa-fw" aria-hidden="true"></i>',
    ],
